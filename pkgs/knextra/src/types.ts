...
> = Knex.QueryBuilder<
  ...
  Array<Knex.TableType<TableT>["base"]>
>;
...
export type Instance<
  TableT extends Knex.TableNames = never,
  RecordT extends {} = Knex.TableType<TableT>["base"],
  InsertT extends {} = Knex.TableType<TableT>["insert"],
> = {
  connection: Knex;
  ...
  whereId(id: IdT | Array<IdT>): QueryBuilder<TableT>;
